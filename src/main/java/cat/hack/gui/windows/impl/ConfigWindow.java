package cat.hack.gui.windows.impl;
...
import cat.hack.gui.clickui.impl.SliderElement;
import cat.hack.gui.font.FontRenderers;
import cat.hack.gui.windows.WindowBase;
import cat.hack.setting.Setting;
import cat.hack.setting.impl.PositionSetting;
...
public class ConfigWindow extends WindowBase {
    ...
    public void render(DrawContext context, int mouseX, int mouseY) {
        ...
        for (ConfigPlate configPlate : configPlates) {
            ...
            FontRenderers.sf_medium.drawString(context.getMatrices(), configPlate.name() + (Objects.equals(configPlate.name() + ".ch", Managers.CONFIG.currentConfig.getName()) ? blink : "")
