...
import cat.hack.utility.render.animation.AnimationUtility;
...
public class ModulePlate {
    ...
    public void render(MatrixStack stack, int MouseX, int MouseY) {
        ...
        if ((posY > CatGui.getInstance().main_posY + CatGui.getInstance().height) || posY < CatGui.getInstance().main_posY) {
            return;
        }
        ...
        if (module.isOn()) {
            Render2DEngine.drawGradientRound(stack, posX + 1, posY, 89, 30, 4f,
                    Render2DEngine.applyOpacity(CatHackGui.onColor1.getValue().getColorObject(), getFadeFactor()),
                    Render2DEngine.applyOpacity(CatHackGui.onColor1.getValue().getColorObject(), getFadeFactor()),
                    Render2DEngine.applyOpacity(CatHackGui.onColor2.getValue().getColorObject(), getFadeFactor()),
                    Render2DEngine.applyOpacity(CatHackGui.onColor2.getValue().getColorObject(), getFadeFactor()));
        } else {
        ...
        if (listening_bind) {
            ...
            if (!holdbind) {
                Render2DEngine.drawRound(stack, posX + 6, posY + 6, 38, 8, 2, Render2DEngine.injectAlpha(CatHackGui.onColor1.getValue().getColorObject(), 170));
                ...
                Render2DEngine.drawRound(stack, posX + 6, posY + 16, 38, 8, 2, Render2DEngine.injectAlpha(CatHackGui.onColor1.getValue().getColorObject(), 170));
