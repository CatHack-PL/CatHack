...
import cat.hack.features.hud.impl.*;
import cat.hack.features.modules.Module;
import cat.hack.features.modules.client.*;
import cat.hack.features.modules.combat.*;
import cat.hack.features.modules.misc.*;
import cat.hack.features.modules.movement.Timer;
import cat.hack.features.modules.movement.*;
import cat.hack.features.modules.player.*;
import cat.hack.features.modules.render.Particles;
import cat.hack.features.modules.render.*;
...
public class ModuleManager implements IManager {
    ...
    public static CatHackGui catHackGui = new CatHackGui();
    ...
    public void onLoad(String category) {
        try {
            CatHack.EVENT_BUS.unsubscribe(unHook);
    ...
    public void onRender2D(DrawContext context) {
        ...
        CatHack.core.onRender2D(context);
    }
