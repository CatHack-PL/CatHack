...
import static cat.hack.utility.render.Render2DEngine.applyOpacity;
...
public class JumpCircle extends Module {
    ...
    public void onEnable() {
        try {
            custom = CatUtility.getCustomImg("circle");
        } catch (Exception e) {
    ...
    public void onUpdate() {
        if (mode.is(Mode.Custom) && custom == null) {
            try {
                ...
                sendMessage(".minecraft -> CatHackPL -> misc -> images -> circle.png");
            }
        }
