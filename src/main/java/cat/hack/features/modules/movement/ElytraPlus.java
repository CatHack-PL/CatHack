...
import cat.hack.features.modules.combat.Criticals;
...
import static cat.hack.features.modules.player.ElytraSwap.getChestPlateSlot;
...
public class ElytraPlus extends Module {
    ...
    private final cat.hack.utility.Timer startTimer = new cat.hack.utility.Timer();
    private final cat.hack.utility.Timer redeployTimer = new cat.hack.utility.Timer();
    private final cat.hack.utility.Timer strictTimer = new cat.hack.utility.Timer();
    private final cat.hack.utility.Timer pingTimer = new cat.hack.utility.Timer();
