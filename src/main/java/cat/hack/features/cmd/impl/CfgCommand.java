...
import cat.hack.features.cmd.args.CategoryArgumentType;
import cat.hack.features.cmd.args.CfgArgumentType;
    ...
    public void executeBuild(@NotNull LiteralArgumentBuilder<CommandSource> builder) {
        builder.executes(context -> {
            ...
            for (String str : Objects.requireNonNull(Managers.CONFIG.getConfigList())) {
                configs.append("\n- " + (str.equals(Managers.CONFIG.getCurrentConfig().getName().replace(".ch", "")) ? Formatting.GREEN : "")).append(str).append(Formatting.RESET);
            }
