package cat.hack.utility.render.shaders;
...
import cat.hack.utility.render.WindowResizeCallback;
import cat.hack.utility.render.shaders.satin.api.managed.ManagedCoreShader;
import cat.hack.utility.render.shaders.satin.api.managed.ShaderEffectManager;
import cat.hack.utility.render.shaders.satin.api.managed.uniform.SamplerUniform;
...
public class BlurProgram {
    ...
    public static final ManagedCoreShader BLUR = ShaderEffectManager.getInstance()
            .manageCoreShader(Identifier.of("cathack", "blur"), VertexFormats.POSITION);
