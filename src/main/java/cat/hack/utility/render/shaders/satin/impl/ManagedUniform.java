 ...
 */
package cat.hack.utility.render.shaders.satin.impl;

import cat.hack.utility.render.shaders.satin.api.managed.uniform.Uniform1f;
import cat.hack.utility.render.shaders.satin.api.managed.uniform.Uniform1i;
import cat.hack.utility.render.shaders.satin.api.managed.uniform.Uniform2f;
import cat.hack.utility.render.shaders.satin.api.managed.uniform.Uniform2i;
import cat.hack.utility.render.shaders.satin.api.managed.uniform.Uniform3f;
import cat.hack.utility.render.shaders.satin.api.managed.uniform.Uniform3i;
import cat.hack.utility.render.shaders.satin.api.managed.uniform.Uniform4f;
import cat.hack.utility.render.shaders.satin.api.managed.uniform.Uniform4i;
import cat.hack.utility.render.shaders.satin.api.managed.uniform.UniformMat4;
